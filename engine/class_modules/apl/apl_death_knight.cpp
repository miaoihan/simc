...
void unholy( player_t* p )
{
  ...
  san_st->add_action( "wound_spender,if=(!talent.apocalypse|cooldown.apocalypse.remains>variable.apoc_timing)&(debuff.festering_wound.stack>=3-pet.abomination.active|buff.vampiric_strike.react)|buff.vampiric_strike.react&debuff.festering_wound.stack>1" );
